...
return view.extend({
    ...
    render: function (result) {
        ...
        const style = E("style", {}, `
            ...
            .jc-badge-type.domain { background-color: rgba(16, 96, 255, 0.1); color: var(--primary-color-medium, #1060FF); border: 1px solid rgba(16, 96, 255, 0.2); }
            .jc-badge-type.ipcidr { background-color: rgba(40, 167, 69, 0.1); color: var(--success-color-medium, #28a745); border: 1px solid rgba(40, 167, 69, 0.2); }
            .jc-badge-type.classical { background-color: rgba(253, 126, 20, 0.1); color: #fd7e14; border: 1px solid rgba(253, 126, 20, 0.2); }
            .jc-badge-builtin { display: inline-block; padding: 0.15rem 0.45rem; border-radius: 0.25rem; font-size: 0.8em; background-color: var(--background-color-medium, #f6f6f6); color: var(--text-color-medium, #888); border: 1px solid var(--border-color-medium, #d9d9d9); font-weight: 500; }
            ...
            .jc-grid-header { display: grid; grid-template-columns: minmax(0, 1.2fr) minmax(0, 1.2fr) minmax(0, 0.8fr) minmax(0, 2.5fr) minmax(0, 1.8fr) 3rem; gap: 0.75rem; padding: 0.625rem 0.9375rem; background-color: var(--background-color-medium, #f6f6f6); border-bottom: 1px solid var(--border-color-medium, #d9d9d9); font-weight: bold; color: var(--text-color-high, inherit); }
            .jc-grid-row { display: grid; grid-template-columns: minmax(0, 1.2fr) minmax(0, 1.2fr) minmax(0, 0.8fr) minmax(0, 2.5fr) minmax(0, 1.8fr) 3rem; gap: 0.75rem; padding: 0.625rem 0.9375rem; align-items: center; border-bottom: 1px solid var(--border-color-low, #f0f0f0); transition: background-color 0.15s ease; color: var(--text-color, inherit); }
            ...
            .jc-grid-col.jc-col-id code { font-family: monospace; }
            ...
            @media (max-width: 48rem) {
                ...
                .jc-grid-row { grid-template-columns: 1fr; gap: 0.625rem; padding: 1rem; border-bottom: 1px solid var(--border-color-medium, #d9d9d9); }
                .jc-grid-row:last-child { border-bottom: none; }
                .jc-grid-col { display: flex; flex-direction: column; align-items: flex-start; width: 100%; }
                .jc-grid-col::before { content: attr(data-label); font-size: 0.8em; font-weight: bold; color: var(--text-color-medium, #888); margin-bottom: 0.25rem; text-transform: uppercase; }
                .jc-grid-col.jc-col-action { align-items: flex-end; margin-top: 0.3125rem; }
